...
public class HarvestStepsTestEast {
	...
	public void testGoEastLimited() {
		...
		East east = new East(field, new int[] { 4 });
		List<Cell> cells = east.doIt(field.getCell(1, 1));
	...
	public void testGoEastWithMowersNorthernNeighbours() {
		...
		EastWithMowersNorthernNeighbours east = new EastWithMowersNorthernNeighbours(field, 2, false, null);
		...
		cells = east.doIt(field.getCell(5, 1));
	...
	public void testGoEastWithMowersNorthernNeighboursLimited() {
		...
		EastWithMowersNorthernNeighbours east = new EastWithMowersNorthernNeighbours(field, 2, false, new int[] { 3 });
	...
	public void testGoEastWithMowersSouthernNeighbours() {
		...
		EastWithMowersSouthernNeighbours east = new EastWithMowersSouthernNeighbours(field, 2, false, null);
	...
	public void testGoEastWithMowersSouthernNeighboursLimited() {
		...
		EastWithMowersSouthernNeighbours east = new EastWithMowersSouthernNeighbours(field, 2, false, new int[] { 2 });
	...
	public void testGoEastWithoutMowing() {
		...
		EastWithoutMowing east = new EastWithoutMowing(field, new int[] { 3 });
