...
public class HarvestStepsTestSouth {
	...
	public void testGoSouthWithMowersEasternNeighbours() {
		...
		SouthWithNeighbours south = new SouthWithNeighbours(Direction.EAST, 2, false, null);
	...
	public void testGoSouthWithMowersEasternNeighboursLimited() {
		...
		SouthWithNeighbours south = new SouthWithNeighbours(Direction.EAST, 2, false, new int[] { 3 });
	...
	public void testGoSouthWithMowersWesternNeighbours() {
		...
		SouthWithNeighbours south = new SouthWithNeighbours(Direction.WEST, 2, false, null);
	...
	public void testGoSouthWithMowersWesternNeighboursLimited() {
		...
		SouthWithNeighbours south = new SouthWithNeighbours(Direction.WEST, 2, false, new int[] { 2 });
