...
public class HarvestStepsTestSouth {
	...
	public void testGoSouth() {
		...
		South south = new South(field, null);
		List<Cell> cells = south.doIt(field.getCell(1, 1));
		...
		cells = south.doIt(field.getCell(2, 1));
		Assert.assertEquals("6 11 16 21 ", OutputFormatter.getFormattedContent(cells));
		Assert.assertEquals(south.getLastCell().getContent(), 21);
	}

	@Test
	public void testGoSouthLimited() {

		CornField field = new CornField(5, 5);

		South south = new South(field, new int[] { 4 });
		List<Cell> cells = south.doIt(field.getCell(1, 1));
		Assert.assertEquals("1 6 11 16 ", OutputFormatter.getFormattedContent(cells));
	...
	public void testGoSouthWithMowersEasternNeighbours() {
		...
		SouthWithMowersEasternNeighbours south = new SouthWithMowersEasternNeighbours(field, 2, false, null);
		...
		cells = south.doIt(field.getCell(1, 4));
	...
	public void testGoSouthWithMowersEasternNeighboursLimited() {
		...
		SouthWithMowersEasternNeighbours south = new SouthWithMowersEasternNeighbours(field, 2, false, new int[] { 3 });
	...
	public void testGoSouthWithMowersWesternNeighbours() {
		...
		SouthWithMowersWesternNeighbours south = new SouthWithMowersWesternNeighbours(field, 2, false, null);
		...
		cells = south.doIt(field.getCell(1, 5));
	...
	public void testGoSouthWithMowersWesternNeighboursLimited() {
		...
		SouthWithMowersWesternNeighbours south = new SouthWithMowersWesternNeighbours(field, 2, false, new int[] { 2 });
	...
	public void testGoSouthWithoutMowing() {
		...
		SouthWithoutMowing south = new SouthWithoutMowing(field, new int[] { 3 });
