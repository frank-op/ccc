...
public class Level6Tester_Turns {
	...
	public void test2() {
		...
		CornField field = new CornField(5, 4);
		System.out.println(field);
		String harvestWith2Mowers = HarvestingCalculator.harvestWith2Mowers(field, Direction.EAST, 4, 1, Style.C);
		System.out.println(harvestWith2Mowers);
	...
	public void test4() {
		...
		CornField field = new CornField(10, 10);
		System.out.println(field);
		String harvestWith2Mowers = HarvestingCalculator.harvestWith2Mowers(field, Direction.WEST, 10, 10, Style.S);
		System.out.println(harvestWith2Mowers);
		Assert.assertEquals(
