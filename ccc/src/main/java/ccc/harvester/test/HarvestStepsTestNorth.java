...
public class HarvestStepsTestNorth {
	...
	public void testGoNorth() {
		...
		North north = new North(field, null);
		List<Cell> cells = north.doIt(field.getCell(5, 1));
		...
		cells = north.doIt(field.getCell(4, 1));
		Assert.assertEquals("16 11 6 1 ", OutputFormatter.getFormattedContent(cells));
		Assert.assertEquals(north.getLastCell().getContent(), 1);
	}

	@Test
	public void testGoNorthLimited() {

		CornField field = new CornField(5, 5);

		North north = new North(field, new int[] { 4 });
		List<Cell> cells = north.doIt(field.getCell(5, 1));
		Assert.assertEquals("21 16 11 6 ", OutputFormatter.getFormattedContent(cells));
	...
	public void testGoNorthWithMowersEasternNeighbours() {
		...
		NorthWithMowersEasternNeighbours north = new NorthWithMowersEasternNeighbours(field, 2, false, null);
		...
		cells = north.doIt(field.getCell(5, 4));
	...
	public void testGoNorthWithMowersEasternNeighboursLimited() {
		...
		NorthWithMowersEasternNeighbours north = new NorthWithMowersEasternNeighbours(field, 2, false, new int[] { 3 });
	...
	public void testGoNorthWithMowersWesternNeighbours() {
		...
		NorthWithMowersWesternNeighbours north = new NorthWithMowersWesternNeighbours(field, 2, false, null);

		List<Cell> cells = north.doIt(field.getCell(5, 1));
		Assert.assertEquals("21 16 11 6 1 ", OutputFormatter.getFormattedContent(cells));
		Assert.assertEquals(north.getLastCell().getContent(), 1);

		cells = north.doIt(field.getCell(2, 1));
		Assert.assertEquals("6 1 ", OutputFormatter.getFormattedContent(cells));
		Assert.assertEquals(north.getLastCell().getContent(), 1);

		cells = north.doIt(field.getCell(5, 5));
	...
	public void testGoNorthWithMowersWesternNeighboursLimited() {
		...
		NorthWithMowersWesternNeighbours north = new NorthWithMowersWesternNeighbours(field, 2, false, new int[] { 2 });
	...
	public void testGoNorthWithoutMowing() {
		...
		NorthWithoutMowing north = new NorthWithoutMowing(field, new int[] { 3 });
