...
public class Level5Tester_TwoMowers {
	...
	public void test1() {
		...
		Assert.assertEquals("1 5 2 6 3 7 4 8 16 12 15 11 14 10 13 9 17 18 19 20 ", result);
	}

	@Test
	public void test2() {
		String result = execute("5 4 4 1 O Z 2");
		Assert.assertEquals("13 17 14 18 15 19 16 20 8 4 7 3 6 2 5 1 9 10 11 12 ", result);
	}
