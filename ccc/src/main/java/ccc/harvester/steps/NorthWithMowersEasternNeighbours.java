...
public class NorthWithMowersEasternNeighbours extends HarvestStep {
	...
	public NorthWithMowersEasternNeighbours(CornField field, int mowers, boolean neighboursFirst, int[] i) {
		this.field = field;
		this.mowers = mowers;
