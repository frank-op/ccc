...
public class Level3Columns {
	...
	public void test() {
		String harvestSerpentinesStartFromGivenCornerColumns = HarvestingCalculator
				.harvestSerpentinesStartFromGivenCornerColumns(new CornField(3, 4), Direction.SOUTH, 1, 1);
		...
		harvestSerpentinesStartFromGivenCornerColumns = HarvestingCalculator
				.harvestSerpentinesStartFromGivenCornerColumns(new CornField(5, 2), Direction.NORTH, 5, 2);
		System.out.println(harvestSerpentinesStartFromGivenCornerColumns);
		Assert.assertEquals(harvestSerpentinesStartFromGivenCornerColumns, "10 8 6 4 2 1 3 5 7 9 ");

		harvestSerpentinesStartFromGivenCornerColumns = HarvestingCalculator
				.harvestSerpentinesStartFromGivenCornerColumns(new CornField(23, 12), Direction.NORTH, 23, 1);
