...
public class Level6Tester_Turns {
	...
	public void test1() {
		...
		String harvestWith2Mowers = HarvestingScenarioExecutor.harvestWithMultipleMowers(field, Direction.EAST, 1, 1, 2,
				Style.S);
	...
	public void test2() {
		...
		CornField field = new CornField(5, 4);
		System.out.println(field);
		String harvestWith2Mowers = HarvestingScenarioExecutor.harvestWithMultipleMowers(field, Direction.EAST, 4, 1, 2,
				Style.C);
		System.out.println(harvestWith2Mowers);
	...
	public void test4() {
		...
		CornField field = new CornField(10, 10);
		System.out.println(field);
		String harvestWith2Mowers = HarvestingScenarioExecutor.harvestWithMultipleMowers(field, Direction.WEST, 10, 10, 2,
				Style.S);
		System.out.println(harvestWith2Mowers);
		Assert.assertEquals(
	...
	public void test5() {
		...
		System.out.println(field);
		String harvestWith2Mowers = HarvestingScenarioExecutor.harvestWithMultipleMowers(field, Direction.NORTH, 17, 1, 2,
				Style.C);
		System.out.println(harvestWith2Mowers);
		Assert.assertEquals(
